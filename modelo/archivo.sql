...
CREATE TABLE reserva (
    ...
    CONSTRAINT chk_sala CHECK (sala IN ('Pecera', 'Laboratorio de ciencias', 'Laboratorio de física', 'Taller de informática', 'Biblioteca', 'Sala de informática', 'Cancha cintetica', 'Comedor escuela', 'Cancha de cemento', 'Sala de arte', 'Sala multiuso', 'Comedor liceo' )),
