...
<body>
    ...
    <td><img src="img/pec.png" alt="" class="img"></td>
    <a href="horario.php">
        <div class="bot">
            <h6>Reservar</h6>
    </div></a> 
    <div class="if2"> <h2 class="car">Caracteristicas</h2><div class="if"> <td>
        <td> <h2 class="info1">Sala para reuniones, con 8 sillas</h2>
        <h2 class="info2">Computadora para cualquier uso</h2>
        <h2 class="info3">Aire acondicionado con control en sala</h2>
        <h2 class="info4">Internet en la computadora</h2></td>
    </td></div></div>
