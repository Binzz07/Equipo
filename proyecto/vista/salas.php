...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <h2 class="info">Sala de informatica</h2>
    <h2 class="lab1">Laboratorio de fisica</h2>
    <h2 class="pec">Pecera</h2>
    <h2 class="taller">Taller de informatica</h2>
    <h3 class="lab2">Laboratorio de quimica</h3>
    <h2 class="bib">Biblioteca</h2>
    <a href="sala.php">
    <div class="boton1">
    </div></a> 
    <a href="lab1.php">
