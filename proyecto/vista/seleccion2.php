        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <h4> <a class="nav-link2" href="misreservas.php">Reservas</a></h4>
                    ...
                    <li class="nav-item">
                        <h4> <a class="nav-link4" href="nosotros.php">Nosotros</a></h4>
                    </li>
                    <li class="nav-item">
                        <h4> <a class="nav-link4" href="formulario.php">Ayuda</a></h4>
                    </li>
                    <li class="nav-item">
                        <h4><a class="nav-link5" href="mostraregistro.php">Usuarios</a></h4>
                    </li>
                </ul>
            </div>
