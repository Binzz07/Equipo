    ...
    <div class="formulario">
        ...
        <form action="" method="post">
            ...
            <select name="hora_inicio" id="hora_inicio">
                <?php
                $horasDisponibles = ['15:30', '16:15', '16:55', '17:40', '18:20', '19:15', '19:55', '20:40'];
            ...
            <select name="sala" id="sala">
                ...
                <option value="Cancha cintetica">Cancha cintetica</option>
                <option value="Comedor escuela">Comedor escuela</option>
                <option value="Cancha de cemento">Cancha de cemento</option>
